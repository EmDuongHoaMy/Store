...
@section('productcatalogue.main')
    <div class="ibox-content ">
        <label for=""><h3>Quản lý nhóm sản phẩm</h3></label>
        {{-- Các chức năng --}}
        <nav class="navbar navbar-expand-sm">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a href="{{ route('productcatalogue.add') }}" class="btn btn-success bg-danger"><i class="fa fa-plus"></i>Thêm mới nhóm sản phẩm</a>
                </li>
            </ul>
        </nav>
