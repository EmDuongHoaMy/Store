    ...
    <table class="table table-striped table-bordered text-center">
        <thead>
            <tr>
                ...
                <th>Mã đơn hàng</th>
                <th>Mã khách hàng</th>
                <th style="width:400px">Tình trạng đơn hàng</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="order-status text-success">{{ $item->current_status->description() }}</td>
                    <td>
                        <a href="{{ route('order.detail',$item->id) }}" class="btn btn-success"><i class="fa-solid fa-circle-info"></i></a>
                    </td>
                    <td><button type="button" id="confirm-button" class="btn btn-warning confirm-button" data-order-id="{{ $item['id'] }}">Xác nhận</button></td>
                </tr>
                @endforeach
            </tbody>
        </thead>
