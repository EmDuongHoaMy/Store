...
<div class="container row justify-content-center m-5 col-md-8">
    <h2 class="mb-4 text-center">Chỉnh sửa thông tin thành viên</h2>
    <div class="card p-4">
        <form action="{{ route('user.update', $users->id) }}" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="email" id="email" placeholder="Nhập email" value="{{ $users->email }}" class="form-control" readonly>
                @if ($errors->has('email'))
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="name" id="name" placeholder="Nhập tên" value="{{ $users->name }}" class="form-control">
                @if ($errors->has('name'))
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="phone_number" id="phone_number" placeholder="Nhập số điện thoại" value="{{ $users->phone_number }}" class="form-control">
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="address" id="address" placeholder="Nhập Địa chỉ" value="{{ $users->address }}" class="form-control">
            </div>
